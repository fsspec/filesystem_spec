...
from .dircache import create_listings_cache
...
class AbstractFileSystem(metaclass=_Cached):
    ...
    def __init__(
        self,
        listings_cache_options: Optional[bool, dict] = None,
        *args,
        **storage_options,
    ):
        ...
        listings_cache_options: bool or dict
            If True, a default MemoryListingsCache cache is created.
            If dict of arguments, used to create a directory cache using
            argument cache_type ("memory" or "file"), expiry_time, and
            other arguments passed to ``MemoryListingsCache`` or ``FileListingsCache``.
        ...
        self.dircache = create_listings_cache(**listings_cache_options)
